<%@ Page Title="" Language="C#" MasterPageFile="~/Seminar.Master" AutoEventWireup="true" CodeFile="CounselorFeedback.aspx.cs" Inherits="CounselorFeedback" %>
                    ...
                    <ContentTemplate>
                                ...
                                <td class="span12" style="text-align: left">
                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                        <tr>
                                            ...
                                            <td style="border-style: none; text-align: left; width: 20%; font-weight:bold">
                                                 UID
                                            </td>
                                            <td style="border-style: none; text-align: left; width: 70%; font-weight:bold">
                                            ...
                                            <td style="border-style: none; text-align: right; width: 100%;">
                                                <asp:DataList ID="dlFeedBackType2" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <td style="text-align : center">
                                                             <label>
                                                                 <input runat="server" id="chkQNo1Ans" name="switch-field-1" type="checkbox" class="ace-switch ace-switch-2"
                            ...
                            <tr id="Tr1" runat="server">
                                <td class="span12" style="text-align: left">
                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                        <tr>
                                            <td style="border-style: none; text-align: right; width: 100%;">
                                                <asp:DataList ID="dlFeedBackType3" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover">
                                                    <HeaderTemplate>
                                                        <b>Question</b></th>
                                                        <th width="65%" style="text-align : center">
                                                            Answer
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <td style="text-align : center">
                                                             <label>
                                                                 <input runat="server" id="chkQNo1Ans" name="switch-field-1" type="text" class="ace-switch ace-switch-2"
                                                                checked="false" visible="true" maxlength="250"/>
                                                                <label style="color:Red">(Max 250 chars.)</label>
                                                                <span class="lbl"></span>
                        ...
                        <div class="row-fluid" style="text-align: center;">
                            <asp:Button class="btn btn-app btn-success btn-mini radius-4" ID="BtnSave" runat="server"
                                Text="Submit" Visible="true" onclick="BtnSave_Click" />
                        </div>
                    </ContentTemplate>
                    <Triggers>
