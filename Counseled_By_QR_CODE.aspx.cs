...
public partial class Counseled_By_QR_CODE : System.Web.UI.Page
{
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                else if (ds.Tables[0].Rows[0]["Result"].ToString() == "1")
                {
                    if (ds.Tables[1].Rows.Count > 0)
                    {
                        ...
                        for (int cnt = 0; cnt <= ddlCouncilBy.Items.Count - 1; cnt++)
                        {
                            if (ddlCouncilBy.Items[cnt].Value == UserID)
                            {
                                ddlCouncilBy.SelectedValue = UserID;
                        ...
                        if (Councilor == 0)
                        {
                            Show_Error_Success_Box("E", "You are not a counsellor");
    ...
    protected void BtnClose_Click(object sender, EventArgs e)
    {
        ...
        //BtnClose.Visible = false;
        //txtSearchUID.Text = "";
        Response.Redirect("Counseled_By_QR_CODE.aspx");
    }
