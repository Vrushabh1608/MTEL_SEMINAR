<%@ Page Title="" Language="C#" MasterPageFile="~/Seminar.Master" AutoEventWireup="true" CodeFile="Attendance_Staff_QR_Code.aspx.cs" Inherits="Attendance_Staff_QR_Code" %>
    ...
    <div class="row-fluid" id="divSeminar" runat="server">
        <asp:UpdatePanel ID="UpdatePanelMsgBox" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <%--<div class="alert alert-block alert-success" id="DivRedirectPage" visible="false" runat="server">                    
                    <p>
                        <asp:Button class="btn btn-app btn-success btn-mini radius-4" ID="btnOk"
            ...
            <div class="row-fluid">
                <%--<asp:UpdatePanel ID="upnlSearchInfo" runat="server" UpdateMode="Conditional">
                        ...
                        <table runat="server" id="tblSearchInfo" visible="false" cellpadding="3" class="table table-striped table-bordered table-condensed">
                            ...
                            <tr>
                                ...
                                <td style="border-style: none; text-align: left; width: 50%;">
                                    ...
                                    <asp:Label runat="server" ID="lblStaffRFID"></asp:Label>
                                </td>
                                <%-- <td style="border-style: none; text-align: left; width: 20%;">                                    
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="BtnSaveAttendance" />
                    </Triggers>
                </asp:UpdatePanel>--%>
            </div>
        </div>
